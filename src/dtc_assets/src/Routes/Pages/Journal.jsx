...
import { dateAisLaterThanOrSameAsDateB, delay, getDateAsString } from "../../functionsAndConstants/Utils";
...
const Journal = (props) => {
    ...
    useEffect(() => {if(counter % 30 === 0) sendData()})
    ...
    const addJournalPage = () => {
        ...
        journalDispatch({ actionType: types.ADD_JOURNAL_PAGE });
    };

    const speedDialActions = [
        {name: "Entry", icon: NoteAddIcon , onClick: addJournalPage},
    ]
    ...
    return(
        ...
        >
            ...
            <Grid columns={12} xs={12} md={9} rowSpacing={8} display="flex" justifyContent="center" alignItems="center" flexDirection={"column"}>
            <FileCarousel
                videoHeight = {'330'}
