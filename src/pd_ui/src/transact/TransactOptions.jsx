...
const TransactOptions = () => {
    ...
    const onReceiveToWallet = () => { console.log("Receive to Wallet"); };
    ...
    return (
        <Grid xs={12} md={9} display="flex" flexDirection={"column"} justifyContent="center" alignItems="center" >
            ...
            <ButtonField transparentBorder={true} color={WHITE_COLOR} transparentBackground={true} Icon={KeyboardArrowRightIcon} text={"Receive to Your Wallet"} gridSx={{ width: "100%"}} sx={{width: "100%"}}/>
